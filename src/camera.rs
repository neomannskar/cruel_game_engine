...
impl Camera for PerspectiveCamera {
    ...
    fn update_matrices(&mut self) {
        ...
        self.view = view;
        let proj = cgmath::perspective(cgmath::Deg(self.fov), self.aspect_ratio, self.near_plane, self.far_plane);
...
impl Camera for OrthographicCamera {
    ...
    fn update_matrices(&mut self) {
        self.view = cgmath::Matrix4::look_at_rh(self.position, self.position + self.orientation, self.up);
        self.projection = cgmath::ortho(self.left, self.right, self.bottom, self.top, self.near_plane, self.far_plane);
    }
